...
namespace ShoppingCart.ProgramConfiguration
{
    public static class ServicesConfiguration
    {
        public static void ConfigureServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                options.UseMySql(configuration.GetConnectionString("csShoppingCart"), new MySqlServerVersion(new Version(8, 0, 23)), sqlOptions => sqlOptions.UseQuerySplittingBehavior(QuerySplittingBehavior.SingleQuery));
            ...
            services.AddTransient<IExcelProcessService, ExcelProcessService>();
            #endregion

            #region Backgrounds
            services.AddHostedService<ExcelBackgroundReaderService>();
            #endregion
        }
    }
}
