namespace Service.Data
{
    public class DTParameters
    {
        ...
        public string OrderBy => Order.Length > 0 ? Columns[Order[0].Column].Data : Columns[0].Data;
        public string SortDirection(DTOrderDir defaultDirect) => Order.Length > 0 ? Order[0].Dir.ToString() : defaultDirect.ToString();
        public string SearchValue => Search.Value;
        
        public long? GetColumnSearchDataAsLong (int index) => !string.IsNullOrWhiteSpace(Columns[index].Search.Value)
            ? Convert.ToInt64(Columns[index].Search.Value) : null;
    }
